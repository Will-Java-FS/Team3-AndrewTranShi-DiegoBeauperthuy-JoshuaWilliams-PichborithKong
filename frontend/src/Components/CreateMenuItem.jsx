				...
				<form onSubmit={handleSubmit} noValidate>
					...
					<div className="relative z-0 w-full mb-5">
						<select
							...
							onChange={handleChange}
							required
							className="pt-5 text-sm pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200">
